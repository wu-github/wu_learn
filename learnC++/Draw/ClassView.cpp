...
void CClassView::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
	// TODO: Add your message handler code here and/or call default

	MessageBox(_T("class view btn down"));
...
void CClassToolBar::OnLButtonDown(UINT nFlags, CPoint point)
{
	// TODO: Add your message handler code here and/or call default

	MessageBox(_T("class tool bar btn down"));
