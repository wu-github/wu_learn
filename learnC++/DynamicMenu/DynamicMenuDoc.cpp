...
void CDynamicMenuDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CDynamicMenuDoc::InitializeSearchContent()
{
...
void CDynamicMenuDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
